...
public class FilterOutProjectNamePredicate implements Predicate<ChangeInfo>, GerritChangeFilter {

    private final String projectNameRegex;

    public FilterOutProjectNamePredicate(final String projectNameRegex) {
        super();
