...
var app = angular.module('statsCollectorApp', ['ui.bootstrap', 'ui.select', 'ui.bootstrap-slider', 'ngSanitize', 'chart.js', 'formly', 'formlyBootstrap'], function (formlyConfigProvider, $locationProvider) {
...
function getOptionsFromValue(value, key, propMetaData) {
  ...
  switch (typeOf) {
    ...
    case 'string':
    default:
    	if(key.match(/actualPassword/i)){
	        typeOptions = {
	        		type: 'hiddenInput',
	        		templateOptions: {type: 'actualPassword'}
	        };
